...
def _run_public_remmaq_sync_background(
    run_id: str,
...
def get_public_air_quality(
    ...
    try:
        if sync:
            ...
            sync_task = prepare_public_remmaq_sync(db, force_sync=False)
            if sync_task is not None:
                background_tasks.add_task(_run_public_remmaq_sync_background, *sync_task)
