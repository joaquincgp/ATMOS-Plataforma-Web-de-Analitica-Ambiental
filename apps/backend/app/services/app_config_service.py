...
CONFIG_DEFINITIONS: tuple[ConfigDefinition, ...] = (
    ConfigDefinition(
        ...
        5000,
        "Limite de puntos para modelos ARIMA/SARIMA",
        "analytics",
        "int",
        1,
        1_000_000,
    ...
    ConfigDefinition(
        ...
        20000,
        "Limite de puntos para modelos Prophet",
        "analytics",
        "int",
        1,
        1_000_000,
    ...
    ConfigDefinition(
        ...
        4000,
        "Maximo de puntos renderizados en graficos avanzados",
        "analytics",
        "int",
        100,
        1_000_000,
    ...
    ConfigDefinition(
        ...
        12,
        "Minimo de observaciones requeridas para SARIMA",
        "analytics",
        "int",
        1,
        10_000,
    ...
    ConfigDefinition(
        ...
        8,
        "Minimo de observaciones requeridas para ARIMA",
        "analytics",
        "int",
        1,
        10_000,
    ...
    ConfigDefinition(
        ...
        3,
        "Minimo de observaciones requeridas para Prophet",
        "analytics",
        "int",
        1,
        10_000,
    ...
    ConfigDefinition(
        ...
        5000,
        "Filas cargadas por defecto en consultas",
        "analytics",
        "int",
        1,
        500_000,
    ...
    ConfigDefinition(
        ...
        300,
        "Maximo de fuentes disponibles en filtros",
        "analytics",
        "int",
        1,
        10_000,
    ...
    ConfigDefinition(
        ...
        1.5,
        "Multiplicador IQR para detectar valores atipicos",
        "analytics",
        "float",
        0.5,
        10,
    ...
    ConfigDefinition(
        ...
        0,
        "Ventana inicial de media movil",
        "workspace",
        "int",
        0,
        3650,
    ...
    ConfigDefinition(
        ...
        21,
        "Ventana inicial de descomposicion STL",
        "workspace",
        "int",
        2,
        3650,
    ...
    ConfigDefinition(
        ...
        30,
        "Horizonte inicial de pronostico (periodos)",
        "workspace",
        "int",
        1,
        365,
    ...
    ConfigDefinition(
        ...
        7,
        "Ventana inicial para changepoints",
        "workspace",
        "int",
        1,
        3650,
    ...
    ConfigDefinition(
        ...
        2,
        "Sensibilidad inicial para changepoints",
        "workspace",
        "float",
        0.1,
        10,
    ...
    ConfigDefinition(
        ...
        32,
        "Numero inicial de bins del histograma",
        "workspace",
        "int",
        1,
        200,
    ...
    ConfigDefinition(
        ...
        0.95,
        "Nivel inicial de intervalo de confianza",
        "workspace",
        "float",
        0.5,
        0.99,
    ...
    ConfigDefinition(
        ...
        0.78,
        "Opacidad inicial de marcadores",
        "workspace",
        "float",
        0.05,
        1,
    ),
    ConfigDefinition("workspace.default_marker_size", 7, "Tamano inicial de marcadores", "workspace", "int", 1, 30),
    ConfigDefinition(
        "workspace.default_facet_columns",
        2,
        "Columnas iniciales para paneles facet",
        "workspace",
        "int",
        1,
        6,
