...
def test_gru_runner_produces_full_result_contract() -> None:
    dataset = _build_synthetic_dataset()
    runner = GruModelRunner()
...
def test_gru_runner_reports_progress_per_epoch() -> None:
    dataset = _build_synthetic_dataset()
    runner = GruModelRunner()
...
def test_gru_runner_is_deterministic_for_a_fixed_seed() -> None:
    dataset = _build_synthetic_dataset()
    runner = GruModelRunner()
